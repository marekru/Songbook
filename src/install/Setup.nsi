...
VIAddVersionKey "LegalCopyright" "© 2013 Kevin W. Hamlen"
...
openlogdone:
  ...
  ${RPath} "src\songidx"
    ${File} "${SRCDIR}\songidx\" "songidx.exe"
    ${File} "${SRCDIR}\songidx\" "authidx.c"
    ${File} "${SRCDIR}\songidx\" "chars.h"
    ${File} "${SRCDIR}\songidx\" "fileio.c"
    ${File} "${SRCDIR}\songidx\" "fileio.h"
    ${File} "${SRCDIR}\songidx\" "scripidx.c"
    ${File} "${SRCDIR}\songidx\" "songidx.c"
    ${File} "${SRCDIR}\songidx\" "songidx.h"
    ${File} "${SRCDIR}\songidx\" "songsort.c"
    ${File} "${SRCDIR}\songidx\" "titleidx.c"
    ${File} "${SRCDIR}\songidx\" "vsconfig.h"
  ...
  ${RPath} "src\sbdchk"
    ${File} "${SRCDIR}\sbdchk\" "sbdchk.exe"
    ${File} "${SRCDIR}\sbdchk\" "chars.h"
    ${File} "${SRCDIR}\sbdchk\" "extract.c"
    ${File} "${SRCDIR}\sbdchk\" "report.c"
    ${File} "${SRCDIR}\sbdchk\" "sbdchk.c"
    ${File} "${SRCDIR}\sbdchk\" "sbdchk.h"
    ${File} "${SRCDIR}\sbdchk\" "vsconfig.h"
    ${File} "${SRCDIR}\sbdchk\" "hyphdict.tex"
  ${EndPath}
